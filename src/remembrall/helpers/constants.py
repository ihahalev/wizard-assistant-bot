...
commands = [['Command', 'Parameters', 'Description'],
                ...
                ['change-address', '[Name] [New Addres]', 'change contact address'],
                ['remove-address', '[Name]', 'remove contact address'],
                ['add-birthday', '[Name] [Birthday]', 'add contact birthday'],
                ['change-birthday', '[Name]' '[NewBirthday]', 'change contact birthday'],
                ...
                ['find-content', '[Content]', 'find notes by content'],
